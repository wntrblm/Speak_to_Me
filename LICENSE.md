# Winterbloom Speak to Me License and Copyright Notices

Speak to Me is (c) 2021 by Winterbloom / Alethea Katherine Flowers
...
1. The functional hardware designs located at `./hardware/board`, and
   `./hardware/headphone-breakout` are available under the CERN-OHL-P v2
   license. Full text is available at https://cern.ch/cern-ohl.
